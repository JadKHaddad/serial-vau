<template>
  <v-container class="mt-2">
    ...
    <v-text-field
      ...
      label="Enter value to send to all ports"
      :append-icon="broadcastValue ? 'mdi-send' : ''"
      @keydown.enter.prevent="
        sendToAllSerialPortsAndClearBroadcastValue(broadcastValue)
      "
      @click:append="sendToAllSerialPortsAndClearBroadcastValue(broadcastValue)"
      clearable
